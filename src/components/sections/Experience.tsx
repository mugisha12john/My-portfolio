    ...
    <div className="exp-edu-grid grid grid-cols-1 lg:grid-cols-2 gap-20">
      ...
      <div>
        ...
        <div className="timeline relative pl-6">
          ...
          <div
            className="timeline-item relative mb-9"
            aria-label="experience-wcam"
          >
            ...
            <div className="timeline-desc font-mono text-[11px] text-text-dim leading-[1.7]">
              Leading a 9-person cross-functional team building WCAM — an IoT
          ...
          <div
            className="timeline-item relative mb-9"
            aria-label="experience-gym-trainee"
          >
            <div className="timeline-dot absolute -left-7 top-1.5 w-2.5 h-2.5 rounded-full bg-bg border-2 border-[rgba(127,238,100,0.3)] transition-all hover:bg-green" />
            <div className="timeline-period font-mono text-[10px] text-green tracking-[0.12em] mb-1.5">
              Feb, 2025 — present
          ...
          <div
            className="timeline-item relative mb-9"
            aria-label="experience-technical-educator"
          >
            <div className="timeline-dot absolute -left-7 top-1.5 w-2.5 h-2.5 rounded-full bg-bg border-2 border-[rgba(127,238,100,0.3)] transition-all hover:bg-green" />
            <div className="timeline-period font-mono text-[10px] text-green tracking-[0.12em] mb-1.5">
              2024 — Present
      ...
      <div>
        ...
        <div className="timeline relative pl-6">
          ...
          <div
            className="timeline-item relative mb-9"
            aria-label="education-bachelors"
          >
            <div className="timeline-dot absolute -left-7 top-1.5 w-2.5 h-2.5 rounded-full bg-bg border-2 border-[rgba(127,238,100,0.3)] transition-all hover:bg-green" />
            <div className="timeline-period font-mono text-[10px] text-green tracking-[0.12em] mb-1.5">
              Ongoing
            ...
            <div className="timeline-desc font-mono text-[11px] text-text-dim leading-[1.7]">
              ...
              architecture. Expected graduation: 2027. Final year project: WCAM
              — IoT water monitoring platform for rural communities.
            </div>
          </div>

          <div
            className="timeline-item relative mb-9"
            aria-label="education-koica-iot"
          >
            <div className="timeline-dot absolute -left-7 top-1.5 w-2.5 h-2.5 rounded-full bg-bg border-2 border-[rgba(127,238,100,0.3)] transition-all hover:bg-green" />
            <div className="timeline-period font-mono text-[10px] text-green tracking-[0.12em] mb-1.5">
              2025
          ...
          <div
            className="timeline-item relative mb-9"
            aria-label="education-koica-game"
          >
            <div className="timeline-dot absolute -left-7 top-1.5 w-2.5 h-2.5 rounded-full bg-bg border-2 border-[rgba(127,238,100,0.3)] transition-all hover:bg-green" />
            <div className="timeline-period font-mono text-[10px] text-green tracking-[0.12em] mb-1.5">
              2025
          ...
          <div className="timeline-item relative">
            ...
            <div className="timeline-desc font-mono text-[11px] text-text-dim leading-[1.7]">
              Continuous growth in system design, IoT protocols, React patterns,
              and backend architecture. Achieved Codewars Trusted User status.
            </div>
          </div>
        </div>
      </div>
