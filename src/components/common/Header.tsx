...
const Header: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-100 px-6 md:px-15 py-5 flex flex-wrap items-center justify-between bg-linear-to-b from-[rgba(10,10,10,0.97)] to-transparent backdrop-blur-sm">
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-bg-2 border-b border-[rgba(127,238,100,0.12)] p-6 flex flex-col gap-6 md:hidden shadow-lg animate-fade-up">
