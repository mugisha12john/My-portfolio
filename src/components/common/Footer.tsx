...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-[rgba(127,238,100,0.12)] py-7 px-15 flex items-center justify-between flex-col sm:flex-row gap-3 text-center sm:text-left">
